...
export class AvaliacaoController {
    ...
    createAvaliacao = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const newAvaliacao = await this.avaliacaoBusiness.createAvaliacao(avaliacao);
    ...
    getAvaliacoesByServicoId = async (req: Request, res: Response): Promise<void> => {
        try {
            const servico_id = Number(req.params.servico_id);
            const avaliacoes = await this.avaliacaoBusiness.getAvaliacoesByServicoId(servico_id);
    ...
    updateAvaliacao = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const updatedAvaliacao = await this.avaliacaoBusiness.updateAvaliacao(id, avaliacao);
            if (updatedAvaliacao) {
